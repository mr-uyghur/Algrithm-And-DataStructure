...
class BinarySearchTree {
    ...
    lookup(value) {
        if (!this.root) {
            return false // if root don't exist
        }
        let currentNode = this.root
        while (currentNode) {
            //loop through our node to find the current node
            if (value < currentNode.value) {
                currentNode = currentNode.left
            } else if (value > currentNode.value) {
                currentNode = currentNode.right
            } else if (currentNode.value === value) { // this condition means we have found the value
                return currentNode // break from while loop
            }
        }
        return false
    }
